    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{ route('admin.academic_degree.update', $academic_degree->id) }}" method="POST">
                    @csrf
                    @method('PATCH')
                    <input type="hidden" name="academic_degree_id" value="{{ $academic_degree->id }}">
                    <div class="card-body">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Название</label>
                            <input type="text" name="name" class="form-control" placeholder="Введите название"
                                value="{{ $academic_degree->name }}">
                            @error('name')
