    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{ route('admin.academic_title.update', $academic_title->id) }}" method="POST">
                    @csrf
                    @method('PATCH')
                    <input type="hidden" name="academic_title_id" value="{{ $academic_title->id }}">
                    <div class="card-body">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Название</label>
                            <input type="text" name="name" class="form-control" placeholder="Введите название"
                                value="{{ $academic_title->name }}">
                            @error('name')
