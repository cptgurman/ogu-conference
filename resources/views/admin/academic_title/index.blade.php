...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="row p-3">
            <div class="content">
                <div class="container-fluid">
                    <a href="{{ route('admin.academic_title.create') }}" type="button" class="btn btn-primary">Добавить</a>
                </div>
                <!-- /.container-fluid -->
            </div>
        </div>
                            ...
                            <tbody>
                                @foreach ($academic_titles as $academic_title)
                                    <tr>
                                        ...
                                        <td colspan="2">{{ $academic_title->name }}</td>
                                        <td>
                                            <a href="{{ route('admin.academic_title.show', $academic_title->id) }}"> <i
                                                    class="fa fa-eye"></i></a>
                                        </td>
                                        <td>
                                            <a href="{{ route('admin.academic_title.edit', $academic_title->id) }}"> <i
                                                    class="fa fa-pen text-green"></i></a>
                                        </td>
                                        <td>
                                            <form action="{{ route('admin.academic_title.delete', $academic_title->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
